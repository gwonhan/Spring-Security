...
public class AuthDetails implements UserDetails {
    ...
    *  UsernamePasswordAuthenticationToken 과 사용자의 아이드를 비교할떄 사용한다.*/
    ...
    *  계정 만료 여부를 표현하는 메소드로 false 이면 해당 계정을 사용할 수 없다.*/
    ...
    /*필기.
    *  잠겨있는 계쩡을 확인하는 메소드 false 이면 해당 계정을 사용할 수 없다.
    ...
    *  비 접속으로 휴면 처리*/
    ...
    /*필기.
    *  탈퇴계정 여부를 표현하는 메소드 false 이면 해당 계정을 사용할 수 없다.
    *  */
    @Override
    ...
    /*필기.
    *  계정 비활성화 여부로 서용자가 사용할 수 없는 상태
    *  false 이면 계정을 사용할 수 없다. 삭제처리 같은 경우.
    * */
